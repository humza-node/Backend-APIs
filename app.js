...
// No need to use express.static for 'images' in memory storage
...
mongoose
  .connect(
    'mongodb+srv://admin:ltKn8qOm9drd5YJ2@students.vdzdpl9.mongodb.net/students?retryWrites=true&w=majority'
  )
  .then((result) => {
    app.listen(3000);
  })
